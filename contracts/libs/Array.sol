...
library Array {
    ...
    function idx(uint256[] memory arr, uint256 item)
        internal
        pure
        returns (uint256 i)
    {
    ...
    function addItem(uint256[] storage arr, uint256 item)
        internal
    {
        if (idx(arr, item) == 0) {
            arr.push(item);
    ...
    function contains(uint256[] memory container, uint256[] memory items)
        internal
        pure
        returns(bool)
    {
    ...
    function hasDuplicatesOrZeros(uint256[] memory array)
        internal
        pure
        returns (bool)
    {
   ...
   function hasRoguesOrZeros(uint256[] memory array)
        internal
        pure
        returns (bool)
    {
